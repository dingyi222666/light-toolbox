...
f1.onClick=function()
  if #from.text~=0 then
    pcall(function()resul.Text=Base64.encodeToString(string2byte(from.Text),1)end)
   o()
   else
    提示("输入为空！")
  end
...
f2.onClick=function()
  if #from.text~=0 then
    pcall(function()resul.Text = String(Base64.decode(string2byte(from.text),1),"UTF-8")end)
   o()
   else
    提示("输入为空！")
  end
